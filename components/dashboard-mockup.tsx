        ...
        <div className="grid grid-cols-1 gap-0 md:grid-cols-4">
          ...
          <div className="hidden border-r border-border/40 bg-secondary/20 p-4 md:block">
            ...
            <div className="flex flex-col gap-1">
              {["Dashboard", "Colaboradores", "Trilhas", "Documentos", "Configurações"].map((item, i) => (
                <div
                  key={item}
          ...
          <div className="col-span-1 p-4 md:col-span-3 md:p-6">
            <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
              <div>
                <h3 className="text-sm font-semibold text-foreground">Onboarding em andamento</h3>
            ...
            <div className="flex flex-col gap-3">
              {[
                { name: "Ana Costa", role: "Dev Frontend", progress: 95, tasks: "12/12", status: "complete" },
                { name: "Pedro Lima", role: "Sales Rep", progress: 68, tasks: "8/12", status: "in-progress" },
                { name: "Julia Santos", role: "Designer UX", progress: 25, tasks: "3/12", status: "in-progress" },
              ].map((person) => (
